...
<aside class="sidebar">
    ...
    <!-- Navigation -->
    <nav class="sb-nav">
    <a href="../faculty/dashboard.php" class="<?= $currentPage === 'dashboard.php' ? 'active' : '' ?>">
        ...
        <a href="../faculty/reservation.php" class="<?= $currentPage === 'reservation.php' ? 'active' : '' ?>">
        ...
        <a href="../faculty/my_reservations.php" class="<?= $currentPage === 'my_reservations.php' ? 'active' : '' ?>">
